...
import { LesseeEditComponent} from './pages/lessee-edit/lessee-edit.component';
import { LesseeListComponent} from './pages/lessee-list/lessee-list.component';
import { RentalEditComponent} from './pages/rental-edit/rental-edit.component';
...
const routes: Routes = [
    ...
    { path: 'homes/:id',  loadChildren: './pages/home-edit/home-edit.module#HomeEditModule' , canActivate: [AuthGuard] },
    { path: 'homes',  loadChildren: './pages/home-list/home-list.module#HomeListModule' , canActivate: [AuthGuard] },
    { path: 'lessees/:id',  loadChildren: './pages/lessee-edit/lessee-edit.module#LesseeEditModule' , canActivate: [AuthGuard] },
    { path: 'lessees',  loadChildren: './pages/lessee-list/lessee-list.module#LesseeListModule' , canActivate: [AuthGuard] },
    { path: 'rentals/:id',  loadChildren: './pages/rental-edit/rental-edit.module#RentalEditModule' , canActivate: [AuthGuard] },
