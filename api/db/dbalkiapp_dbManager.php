...
function getConnection() {
	...
	global $db_alkiapp_db_Url, $db_alkiapp_db_User, $db_alkiapp_db_Pass, $db_alkiapp_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_alkiapp_db_Url.";dbname=".$db_alkiapp_db_DbName, $db_alkiapp_db_User, $db_alkiapp_db_Pass);
